                ...
                <div class="card" style="background-color: #003788">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <h3 class="mx-2 text-light">{{ \App\Models\suplier::count() }}</h3>
                        </div>
                ...
                <div class="card" style="background-color: #003788">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <h3 class="mx-2 text-light">{{ \App\Models\pelanggan::count() }}</h3>
                        </div>
                        <div class="mt-2 text-end">
                ...
                <div class="card" style="background-color: #003788">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <h3 class="mx-2 text-light">{{ \App\Models\stok::count() }}</h3>
                        </div>
                        <div class="mt-2 text-end">
